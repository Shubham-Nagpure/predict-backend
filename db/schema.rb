...
ActiveRecord::Schema[7.2].define(version: 2025_04_03_073824) do
  ...
  create_table "contest_results", force: :cascade do |t|
    ...
    t.index ["team_id"], name: "index_contest_results_on_team_id"
  end
  ...
  create_table "reward_points", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contest_id"], name: "index_reward_points_on_contest_id"
  ...
  create_table "tosses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["team_one_id"], name: "index_tosses_on_team_one_id"
    t.index ["team_two_id"], name: "index_tosses_on_team_two_id"
  end
  ...
  add_foreign_key "tosses", "teams", column: "team_one_id"
  add_foreign_key "tosses", "teams", column: "team_two_id"
end
